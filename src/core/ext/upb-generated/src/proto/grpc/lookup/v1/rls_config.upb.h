...
#ifndef GRPC_LOOKUP_V1_RLS_CONFIG_PROTO_UPB_H_
#define GRPC_LOOKUP_V1_RLS_CONFIG_PROTO_UPB_H_
...
extern const GRPCUPB upb_MiniTable* grpc_lookup_v1_NameMatcher_msg_init();
extern const GRPCUPB upb_MiniTable* grpc_lookup_v1_GrpcKeyBuilder_msg_init();
extern const GRPCUPB upb_MiniTable* grpc_lookup_v1_GrpcKeyBuilder_Name_msg_init();
extern const GRPCUPB upb_MiniTable* grpc_lookup_v1_GrpcKeyBuilder_ExtraKeys_msg_init();
extern const GRPCUPB upb_MiniTable* grpc_lookup_v1_GrpcKeyBuilder_ConstantKeysEntry_msg_init();
extern const GRPCUPB upb_MiniTable* grpc_lookup_v1_HttpKeyBuilder_msg_init();
extern const GRPCUPB upb_MiniTable* grpc_lookup_v1_HttpKeyBuilder_ConstantKeysEntry_msg_init();
extern const GRPCUPB upb_MiniTable* grpc_lookup_v1_RouteLookupConfig_msg_init();
extern const GRPCUPB upb_MiniTable* grpc_lookup_v1_RouteLookupClusterSpecifier_msg_init();
extern const GRPCUPB upb_MiniTable* google_protobuf_Duration_msg_init();
...
UPB_INLINE void grpc_lookup_v1_NameMatcher_clear_key(grpc_lookup_v1_NameMatcher* msg) {
  const upb_MiniTableField field = *upb_MiniTable_FindFieldByNumber(grpc_lookup_v1_NameMatcher_msg_init(), 1);
...
UPB_INLINE void grpc_lookup_v1_NameMatcher_clear_names(grpc_lookup_v1_NameMatcher* msg) {
  const upb_MiniTableField field = *upb_MiniTable_FindFieldByNumber(grpc_lookup_v1_NameMatcher_msg_init(), 2);
  _upb_Message_ClearNonExtensionField(msg, &field);
}
...
UPB_INLINE void grpc_lookup_v1_NameMatcher_clear_required_match(grpc_lookup_v1_NameMatcher* msg) {
  const upb_MiniTableField field = *upb_MiniTable_FindFieldByNumber(grpc_lookup_v1_NameMatcher_msg_init(), 3);
  _upb_Message_ClearNonExtensionField(msg, &field);
}
...
UPB_INLINE upb_StringView* grpc_lookup_v1_NameMatcher_mutable_names(grpc_lookup_v1_NameMatcher* msg, size_t* size) {
  upb_MiniTableField field = *upb_MiniTable_FindFieldByNumber(grpc_lookup_v1_NameMatcher_msg_init(), 2);
...
UPB_INLINE void grpc_lookup_v1_GrpcKeyBuilder_clear_names(grpc_lookup_v1_GrpcKeyBuilder* msg) {
  const upb_MiniTableField field = *upb_MiniTable_FindFieldByNumber(grpc_lookup_v1_GrpcKeyBuilder_msg_init(), 1);
  _upb_Message_ClearNonExtensionField(msg, &field);
}
...
UPB_INLINE void grpc_lookup_v1_GrpcKeyBuilder_clear_headers(grpc_lookup_v1_GrpcKeyBuilder* msg) {
  const upb_MiniTableField field = *upb_MiniTable_FindFieldByNumber(grpc_lookup_v1_GrpcKeyBuilder_msg_init(), 2);
  _upb_Message_ClearNonExtensionField(msg, &field);
}
...
UPB_INLINE void grpc_lookup_v1_GrpcKeyBuilder_clear_extra_keys(grpc_lookup_v1_GrpcKeyBuilder* msg) {
  const upb_MiniTableField field = *upb_MiniTable_FindFieldByNumber(grpc_lookup_v1_GrpcKeyBuilder_msg_init(), 3);
  _upb_Message_ClearNonExtensionField(msg, &field);
}
...
UPB_INLINE void grpc_lookup_v1_GrpcKeyBuilder_clear_constant_keys(grpc_lookup_v1_GrpcKeyBuilder* msg) {
  const upb_MiniTableField field = *upb_MiniTable_FindFieldByNumber(grpc_lookup_v1_GrpcKeyBuilder_msg_init(), 4);
  _upb_Message_ClearNonExtensionField(msg, &field);
}
...
UPB_INLINE grpc_lookup_v1_GrpcKeyBuilder_Name** grpc_lookup_v1_GrpcKeyBuilder_mutable_names(grpc_lookup_v1_GrpcKeyBuilder* msg, size_t* size) {
  upb_MiniTableField field = *upb_MiniTable_FindFieldByNumber(grpc_lookup_v1_GrpcKeyBuilder_msg_init(), 1);
  upb_Array* arr = upb_Message_GetMutableArray(msg, &field);
  if (arr) {
    if (size) *size = arr->size;
...
UPB_INLINE grpc_lookup_v1_NameMatcher** grpc_lookup_v1_GrpcKeyBuilder_mutable_headers(grpc_lookup_v1_GrpcKeyBuilder* msg, size_t* size) {
  upb_MiniTableField field = *upb_MiniTable_FindFieldByNumber(grpc_lookup_v1_GrpcKeyBuilder_msg_init(), 2);
  upb_Array* arr = upb_Message_GetMutableArray(msg, &field);
  if (arr) {
    if (size) *size = arr->size;
...
UPB_INLINE void grpc_lookup_v1_GrpcKeyBuilder_Name_clear_service(grpc_lookup_v1_GrpcKeyBuilder_Name* msg) {
  const upb_MiniTableField field = *upb_MiniTable_FindFieldByNumber(grpc_lookup_v1_GrpcKeyBuilder_Name_msg_init(), 1);
  _upb_Message_ClearNonExtensionField(msg, &field);
}
...
UPB_INLINE void grpc_lookup_v1_GrpcKeyBuilder_Name_clear_method(grpc_lookup_v1_GrpcKeyBuilder_Name* msg) {
  const upb_MiniTableField field = *upb_MiniTable_FindFieldByNumber(grpc_lookup_v1_GrpcKeyBuilder_Name_msg_init(), 2);
  _upb_Message_ClearNonExtensionField(msg, &field);
}
...
UPB_INLINE void grpc_lookup_v1_GrpcKeyBuilder_ExtraKeys_clear_host(grpc_lookup_v1_GrpcKeyBuilder_ExtraKeys* msg) {
  const upb_MiniTableField field = *upb_MiniTable_FindFieldByNumber(grpc_lookup_v1_GrpcKeyBuilder_ExtraKeys_msg_init(), 1);
  _upb_Message_ClearNonExtensionField(msg, &field);
}
...
UPB_INLINE void grpc_lookup_v1_GrpcKeyBuilder_ExtraKeys_clear_service(grpc_lookup_v1_GrpcKeyBuilder_ExtraKeys* msg) {
  const upb_MiniTableField field = *upb_MiniTable_FindFieldByNumber(grpc_lookup_v1_GrpcKeyBuilder_ExtraKeys_msg_init(), 2);
  _upb_Message_ClearNonExtensionField(msg, &field);
}
...
UPB_INLINE void grpc_lookup_v1_GrpcKeyBuilder_ExtraKeys_clear_method(grpc_lookup_v1_GrpcKeyBuilder_ExtraKeys* msg) {
  const upb_MiniTableField field = *upb_MiniTable_FindFieldByNumber(grpc_lookup_v1_GrpcKeyBuilder_ExtraKeys_msg_init(), 3);
  _upb_Message_ClearNonExtensionField(msg, &field);
}
...
UPB_INLINE void grpc_lookup_v1_HttpKeyBuilder_clear_host_patterns(grpc_lookup_v1_HttpKeyBuilder* msg) {
  const upb_MiniTableField field = *upb_MiniTable_FindFieldByNumber(grpc_lookup_v1_HttpKeyBuilder_msg_init(), 1);
  _upb_Message_ClearNonExtensionField(msg, &field);
}
...
UPB_INLINE void grpc_lookup_v1_HttpKeyBuilder_clear_path_patterns(grpc_lookup_v1_HttpKeyBuilder* msg) {
  const upb_MiniTableField field = *upb_MiniTable_FindFieldByNumber(grpc_lookup_v1_HttpKeyBuilder_msg_init(), 2);
  _upb_Message_ClearNonExtensionField(msg, &field);
}
...
UPB_INLINE void grpc_lookup_v1_HttpKeyBuilder_clear_query_parameters(grpc_lookup_v1_HttpKeyBuilder* msg) {
  const upb_MiniTableField field = *upb_MiniTable_FindFieldByNumber(grpc_lookup_v1_HttpKeyBuilder_msg_init(), 3);
  _upb_Message_ClearNonExtensionField(msg, &field);
}
...
UPB_INLINE void grpc_lookup_v1_HttpKeyBuilder_clear_headers(grpc_lookup_v1_HttpKeyBuilder* msg) {
  const upb_MiniTableField field = *upb_MiniTable_FindFieldByNumber(grpc_lookup_v1_HttpKeyBuilder_msg_init(), 4);
  _upb_Message_ClearNonExtensionField(msg, &field);
}
...
UPB_INLINE void grpc_lookup_v1_HttpKeyBuilder_clear_constant_keys(grpc_lookup_v1_HttpKeyBuilder* msg) {
  const upb_MiniTableField field = *upb_MiniTable_FindFieldByNumber(grpc_lookup_v1_HttpKeyBuilder_msg_init(), 5);
  _upb_Message_ClearNonExtensionField(msg, &field);
}
...
UPB_INLINE upb_StringView* grpc_lookup_v1_HttpKeyBuilder_mutable_host_patterns(grpc_lookup_v1_HttpKeyBuilder* msg, size_t* size) {
  upb_MiniTableField field = *upb_MiniTable_FindFieldByNumber(grpc_lookup_v1_HttpKeyBuilder_msg_init(), 1);
  upb_Array* arr = upb_Message_GetMutableArray(msg, &field);
  if (arr) {
    if (size) *size = arr->size;
    return (upb_StringView*)_upb_array_ptr(arr);
...
UPB_INLINE upb_StringView* grpc_lookup_v1_HttpKeyBuilder_mutable_path_patterns(grpc_lookup_v1_HttpKeyBuilder* msg, size_t* size) {
  upb_MiniTableField field = *upb_MiniTable_FindFieldByNumber(grpc_lookup_v1_HttpKeyBuilder_msg_init(), 2);
  upb_Array* arr = upb_Message_GetMutableArray(msg, &field);
  if (arr) {
    if (size) *size = arr->size;
    return (upb_StringView*)_upb_array_ptr(arr);
...
UPB_INLINE grpc_lookup_v1_NameMatcher** grpc_lookup_v1_HttpKeyBuilder_mutable_query_parameters(grpc_lookup_v1_HttpKeyBuilder* msg, size_t* size) {
  upb_MiniTableField field = *upb_MiniTable_FindFieldByNumber(grpc_lookup_v1_HttpKeyBuilder_msg_init(), 3);
  upb_Array* arr = upb_Message_GetMutableArray(msg, &field);
  if (arr) {
    if (size) *size = arr->size;
    return (grpc_lookup_v1_NameMatcher**)_upb_array_ptr(arr);
...
UPB_INLINE grpc_lookup_v1_NameMatcher** grpc_lookup_v1_HttpKeyBuilder_mutable_headers(grpc_lookup_v1_HttpKeyBuilder* msg, size_t* size) {
  upb_MiniTableField field = *upb_MiniTable_FindFieldByNumber(grpc_lookup_v1_HttpKeyBuilder_msg_init(), 4);
  upb_Array* arr = upb_Message_GetMutableArray(msg, &field);
  if (arr) {
    if (size) *size = arr->size;
    return (grpc_lookup_v1_NameMatcher**)_upb_array_ptr(arr);
...
UPB_INLINE void grpc_lookup_v1_RouteLookupConfig_clear_http_keybuilders(grpc_lookup_v1_RouteLookupConfig* msg) {
  const upb_MiniTableField field = *upb_MiniTable_FindFieldByNumber(grpc_lookup_v1_RouteLookupConfig_msg_init(), 1);
  _upb_Message_ClearNonExtensionField(msg, &field);
}
...
UPB_INLINE void grpc_lookup_v1_RouteLookupConfig_clear_grpc_keybuilders(grpc_lookup_v1_RouteLookupConfig* msg) {
  const upb_MiniTableField field = *upb_MiniTable_FindFieldByNumber(grpc_lookup_v1_RouteLookupConfig_msg_init(), 2);
  _upb_Message_ClearNonExtensionField(msg, &field);
}
...
UPB_INLINE void grpc_lookup_v1_RouteLookupConfig_clear_lookup_service(grpc_lookup_v1_RouteLookupConfig* msg) {
  const upb_MiniTableField field = *upb_MiniTable_FindFieldByNumber(grpc_lookup_v1_RouteLookupConfig_msg_init(), 3);
  _upb_Message_ClearNonExtensionField(msg, &field);
}
...
UPB_INLINE void grpc_lookup_v1_RouteLookupConfig_clear_lookup_service_timeout(grpc_lookup_v1_RouteLookupConfig* msg) {
  const upb_MiniTableField field = *upb_MiniTable_FindFieldByNumber(grpc_lookup_v1_RouteLookupConfig_msg_init(), 4);
  _upb_Message_ClearNonExtensionField(msg, &field);
}
...
UPB_INLINE void grpc_lookup_v1_RouteLookupConfig_clear_max_age(grpc_lookup_v1_RouteLookupConfig* msg) {
  const upb_MiniTableField field = *upb_MiniTable_FindFieldByNumber(grpc_lookup_v1_RouteLookupConfig_msg_init(), 5);
  _upb_Message_ClearNonExtensionField(msg, &field);
}
...
UPB_INLINE void grpc_lookup_v1_RouteLookupConfig_clear_stale_age(grpc_lookup_v1_RouteLookupConfig* msg) {
  const upb_MiniTableField field = *upb_MiniTable_FindFieldByNumber(grpc_lookup_v1_RouteLookupConfig_msg_init(), 6);
  _upb_Message_ClearNonExtensionField(msg, &field);
}
...
UPB_INLINE void grpc_lookup_v1_RouteLookupConfig_clear_cache_size_bytes(grpc_lookup_v1_RouteLookupConfig* msg) {
  const upb_MiniTableField field = *upb_MiniTable_FindFieldByNumber(grpc_lookup_v1_RouteLookupConfig_msg_init(), 7);
  _upb_Message_ClearNonExtensionField(msg, &field);
}
...
UPB_INLINE void grpc_lookup_v1_RouteLookupConfig_clear_valid_targets(grpc_lookup_v1_RouteLookupConfig* msg) {
  const upb_MiniTableField field = *upb_MiniTable_FindFieldByNumber(grpc_lookup_v1_RouteLookupConfig_msg_init(), 8);
  _upb_Message_ClearNonExtensionField(msg, &field);
}
...
UPB_INLINE void grpc_lookup_v1_RouteLookupConfig_clear_default_target(grpc_lookup_v1_RouteLookupConfig* msg) {
  const upb_MiniTableField field = *upb_MiniTable_FindFieldByNumber(grpc_lookup_v1_RouteLookupConfig_msg_init(), 9);
  _upb_Message_ClearNonExtensionField(msg, &field);
}
...
UPB_INLINE grpc_lookup_v1_HttpKeyBuilder** grpc_lookup_v1_RouteLookupConfig_mutable_http_keybuilders(grpc_lookup_v1_RouteLookupConfig* msg, size_t* size) {
  upb_MiniTableField field = *upb_MiniTable_FindFieldByNumber(grpc_lookup_v1_RouteLookupConfig_msg_init(), 1);
  upb_Array* arr = upb_Message_GetMutableArray(msg, &field);
  if (arr) {
    if (size) *size = arr->size;
...
UPB_INLINE grpc_lookup_v1_GrpcKeyBuilder** grpc_lookup_v1_RouteLookupConfig_mutable_grpc_keybuilders(grpc_lookup_v1_RouteLookupConfig* msg, size_t* size) {
  upb_MiniTableField field = *upb_MiniTable_FindFieldByNumber(grpc_lookup_v1_RouteLookupConfig_msg_init(), 2);
  upb_Array* arr = upb_Message_GetMutableArray(msg, &field);
  if (arr) {
    if (size) *size = arr->size;
...
UPB_INLINE upb_StringView* grpc_lookup_v1_RouteLookupConfig_mutable_valid_targets(grpc_lookup_v1_RouteLookupConfig* msg, size_t* size) {
  upb_MiniTableField field = *upb_MiniTable_FindFieldByNumber(grpc_lookup_v1_RouteLookupConfig_msg_init(), 8);
  upb_Array* arr = upb_Message_GetMutableArray(msg, &field);
  if (arr) {
    if (size) *size = arr->size;
    return (upb_StringView*)_upb_array_ptr(arr);
...
UPB_INLINE void grpc_lookup_v1_RouteLookupClusterSpecifier_clear_route_lookup_config(grpc_lookup_v1_RouteLookupClusterSpecifier* msg) {
  const upb_MiniTableField field = *upb_MiniTable_FindFieldByNumber(grpc_lookup_v1_RouteLookupClusterSpecifier_msg_init(), 1);
  _upb_Message_ClearNonExtensionField(msg, &field);
}
...
#endif  /* GRPC_LOOKUP_V1_RLS_CONFIG_PROTO_UPB_H_ */
