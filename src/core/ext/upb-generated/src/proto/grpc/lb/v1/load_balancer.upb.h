...
extern const GRPCUPB upb_MiniTable* grpc_lb_v1_LoadBalanceRequest_msg_init();
extern const GRPCUPB upb_MiniTable* grpc_lb_v1_InitialLoadBalanceRequest_msg_init();
extern const GRPCUPB upb_MiniTable* grpc_lb_v1_ClientStatsPerToken_msg_init();
extern const GRPCUPB upb_MiniTable* grpc_lb_v1_ClientStats_msg_init();
extern const GRPCUPB upb_MiniTable* grpc_lb_v1_LoadBalanceResponse_msg_init();
extern const GRPCUPB upb_MiniTable* grpc_lb_v1_FallbackResponse_msg_init();
extern const GRPCUPB upb_MiniTable* grpc_lb_v1_InitialLoadBalanceResponse_msg_init();
extern const GRPCUPB upb_MiniTable* grpc_lb_v1_ServerList_msg_init();
extern const GRPCUPB upb_MiniTable* grpc_lb_v1_Server_msg_init();
extern const GRPCUPB upb_MiniTable* google_protobuf_Duration_msg_init();
extern const GRPCUPB upb_MiniTable* google_protobuf_Timestamp_msg_init();
...
UPB_INLINE grpc_lb_v1_LoadBalanceRequest_load_balance_request_type_oneofcases grpc_lb_v1_LoadBalanceRequest_load_balance_request_type_case(const grpc_lb_v1_LoadBalanceRequest* msg) {
  const upb_MiniTableField field = *upb_MiniTable_FindFieldByNumber(grpc_lb_v1_LoadBalanceRequest_msg_init(), 1);
...
UPB_INLINE void grpc_lb_v1_LoadBalanceRequest_clear_client_stats(grpc_lb_v1_LoadBalanceRequest* msg) {
  const upb_MiniTableField field = *upb_MiniTable_FindFieldByNumber(grpc_lb_v1_LoadBalanceRequest_msg_init(), 2);
  _upb_Message_ClearNonExtensionField(msg, &field);
}
...
UPB_INLINE void grpc_lb_v1_InitialLoadBalanceRequest_clear_name(grpc_lb_v1_InitialLoadBalanceRequest* msg) {
  const upb_MiniTableField field = *upb_MiniTable_FindFieldByNumber(grpc_lb_v1_InitialLoadBalanceRequest_msg_init(), 1);
  _upb_Message_ClearNonExtensionField(msg, &field);
}
...
UPB_INLINE void grpc_lb_v1_ClientStatsPerToken_clear_load_balance_token(grpc_lb_v1_ClientStatsPerToken* msg) {
  const upb_MiniTableField field = *upb_MiniTable_FindFieldByNumber(grpc_lb_v1_ClientStatsPerToken_msg_init(), 1);
  _upb_Message_ClearNonExtensionField(msg, &field);
}
...
UPB_INLINE void grpc_lb_v1_ClientStatsPerToken_clear_num_calls(grpc_lb_v1_ClientStatsPerToken* msg) {
  const upb_MiniTableField field = *upb_MiniTable_FindFieldByNumber(grpc_lb_v1_ClientStatsPerToken_msg_init(), 2);
  _upb_Message_ClearNonExtensionField(msg, &field);
}
...
UPB_INLINE void grpc_lb_v1_ClientStats_clear_timestamp(grpc_lb_v1_ClientStats* msg) {
  const upb_MiniTableField field = *upb_MiniTable_FindFieldByNumber(grpc_lb_v1_ClientStats_msg_init(), 1);
  _upb_Message_ClearNonExtensionField(msg, &field);
}
...
UPB_INLINE void grpc_lb_v1_ClientStats_clear_num_calls_started(grpc_lb_v1_ClientStats* msg) {
  const upb_MiniTableField field = *upb_MiniTable_FindFieldByNumber(grpc_lb_v1_ClientStats_msg_init(), 2);
  _upb_Message_ClearNonExtensionField(msg, &field);
}
...
UPB_INLINE void grpc_lb_v1_ClientStats_clear_num_calls_finished(grpc_lb_v1_ClientStats* msg) {
  const upb_MiniTableField field = *upb_MiniTable_FindFieldByNumber(grpc_lb_v1_ClientStats_msg_init(), 3);
  _upb_Message_ClearNonExtensionField(msg, &field);
}
...
UPB_INLINE void grpc_lb_v1_ClientStats_clear_num_calls_finished_with_client_failed_to_send(grpc_lb_v1_ClientStats* msg) {
  const upb_MiniTableField field = *upb_MiniTable_FindFieldByNumber(grpc_lb_v1_ClientStats_msg_init(), 6);
  _upb_Message_ClearNonExtensionField(msg, &field);
}
...
UPB_INLINE void grpc_lb_v1_ClientStats_clear_num_calls_finished_known_received(grpc_lb_v1_ClientStats* msg) {
  const upb_MiniTableField field = *upb_MiniTable_FindFieldByNumber(grpc_lb_v1_ClientStats_msg_init(), 7);
  _upb_Message_ClearNonExtensionField(msg, &field);
}
...
UPB_INLINE void grpc_lb_v1_ClientStats_clear_calls_finished_with_drop(grpc_lb_v1_ClientStats* msg) {
  const upb_MiniTableField field = *upb_MiniTable_FindFieldByNumber(grpc_lb_v1_ClientStats_msg_init(), 8);
  _upb_Message_ClearNonExtensionField(msg, &field);
}
...
UPB_INLINE grpc_lb_v1_ClientStatsPerToken** grpc_lb_v1_ClientStats_mutable_calls_finished_with_drop(grpc_lb_v1_ClientStats* msg, size_t* size) {
  upb_MiniTableField field = *upb_MiniTable_FindFieldByNumber(grpc_lb_v1_ClientStats_msg_init(), 8);
...
UPB_INLINE grpc_lb_v1_LoadBalanceResponse_load_balance_response_type_oneofcases grpc_lb_v1_LoadBalanceResponse_load_balance_response_type_case(const grpc_lb_v1_LoadBalanceResponse* msg) {
  const upb_MiniTableField field = *upb_MiniTable_FindFieldByNumber(grpc_lb_v1_LoadBalanceResponse_msg_init(), 1);
...
UPB_INLINE void grpc_lb_v1_LoadBalanceResponse_clear_server_list(grpc_lb_v1_LoadBalanceResponse* msg) {
  const upb_MiniTableField field = *upb_MiniTable_FindFieldByNumber(grpc_lb_v1_LoadBalanceResponse_msg_init(), 2);
  _upb_Message_ClearNonExtensionField(msg, &field);
}
...
UPB_INLINE void grpc_lb_v1_LoadBalanceResponse_clear_fallback_response(grpc_lb_v1_LoadBalanceResponse* msg) {
  const upb_MiniTableField field = *upb_MiniTable_FindFieldByNumber(grpc_lb_v1_LoadBalanceResponse_msg_init(), 3);
  _upb_Message_ClearNonExtensionField(msg, &field);
}
...
UPB_INLINE void grpc_lb_v1_InitialLoadBalanceResponse_clear_client_stats_report_interval(grpc_lb_v1_InitialLoadBalanceResponse* msg) {
  const upb_MiniTableField field = *upb_MiniTable_FindFieldByNumber(grpc_lb_v1_InitialLoadBalanceResponse_msg_init(), 2);
  _upb_Message_ClearNonExtensionField(msg, &field);
}
...
UPB_INLINE void grpc_lb_v1_ServerList_clear_servers(grpc_lb_v1_ServerList* msg) {
  const upb_MiniTableField field = *upb_MiniTable_FindFieldByNumber(grpc_lb_v1_ServerList_msg_init(), 1);
  _upb_Message_ClearNonExtensionField(msg, &field);
}
...
UPB_INLINE grpc_lb_v1_Server** grpc_lb_v1_ServerList_mutable_servers(grpc_lb_v1_ServerList* msg, size_t* size) {
  upb_MiniTableField field = *upb_MiniTable_FindFieldByNumber(grpc_lb_v1_ServerList_msg_init(), 1);
  upb_Array* arr = upb_Message_GetMutableArray(msg, &field);
  if (arr) {
    if (size) *size = arr->size;
...
UPB_INLINE void grpc_lb_v1_Server_clear_ip_address(grpc_lb_v1_Server* msg) {
  const upb_MiniTableField field = *upb_MiniTable_FindFieldByNumber(grpc_lb_v1_Server_msg_init(), 1);
  _upb_Message_ClearNonExtensionField(msg, &field);
}
...
UPB_INLINE void grpc_lb_v1_Server_clear_port(grpc_lb_v1_Server* msg) {
  const upb_MiniTableField field = *upb_MiniTable_FindFieldByNumber(grpc_lb_v1_Server_msg_init(), 2);
  _upb_Message_ClearNonExtensionField(msg, &field);
}
...
UPB_INLINE void grpc_lb_v1_Server_clear_load_balance_token(grpc_lb_v1_Server* msg) {
  const upb_MiniTableField field = *upb_MiniTable_FindFieldByNumber(grpc_lb_v1_Server_msg_init(), 3);
  _upb_Message_ClearNonExtensionField(msg, &field);
}
...
UPB_INLINE void grpc_lb_v1_Server_clear_drop(grpc_lb_v1_Server* msg) {
  const upb_MiniTableField field = *upb_MiniTable_FindFieldByNumber(grpc_lb_v1_Server_msg_init(), 4);
  _upb_Message_ClearNonExtensionField(msg, &field);
}
