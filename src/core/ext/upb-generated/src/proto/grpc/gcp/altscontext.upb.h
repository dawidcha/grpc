...
extern const GRPCUPB upb_MiniTable* grpc_gcp_AltsContext_msg_init();
extern const GRPCUPB upb_MiniTable* grpc_gcp_AltsContext_PeerAttributesEntry_msg_init();
...
UPB_INLINE void grpc_gcp_AltsContext_clear_application_protocol(grpc_gcp_AltsContext* msg) {
  const upb_MiniTableField field = *upb_MiniTable_FindFieldByNumber(grpc_gcp_AltsContext_msg_init(), 1);
...
UPB_INLINE void grpc_gcp_AltsContext_clear_record_protocol(grpc_gcp_AltsContext* msg) {
  const upb_MiniTableField field = *upb_MiniTable_FindFieldByNumber(grpc_gcp_AltsContext_msg_init(), 2);
  _upb_Message_ClearNonExtensionField(msg, &field);
}
...
UPB_INLINE void grpc_gcp_AltsContext_clear_security_level(grpc_gcp_AltsContext* msg) {
  const upb_MiniTableField field = *upb_MiniTable_FindFieldByNumber(grpc_gcp_AltsContext_msg_init(), 3);
  _upb_Message_ClearNonExtensionField(msg, &field);
}
...
UPB_INLINE void grpc_gcp_AltsContext_clear_peer_service_account(grpc_gcp_AltsContext* msg) {
  const upb_MiniTableField field = *upb_MiniTable_FindFieldByNumber(grpc_gcp_AltsContext_msg_init(), 4);
  _upb_Message_ClearNonExtensionField(msg, &field);
}
...
UPB_INLINE void grpc_gcp_AltsContext_clear_local_service_account(grpc_gcp_AltsContext* msg) {
  const upb_MiniTableField field = *upb_MiniTable_FindFieldByNumber(grpc_gcp_AltsContext_msg_init(), 5);
  _upb_Message_ClearNonExtensionField(msg, &field);
}
...
UPB_INLINE void grpc_gcp_AltsContext_clear_peer_rpc_versions(grpc_gcp_AltsContext* msg) {
  const upb_MiniTableField field = *upb_MiniTable_FindFieldByNumber(grpc_gcp_AltsContext_msg_init(), 6);
  _upb_Message_ClearNonExtensionField(msg, &field);
}
...
UPB_INLINE void grpc_gcp_AltsContext_clear_peer_attributes(grpc_gcp_AltsContext* msg) {
  const upb_MiniTableField field = *upb_MiniTable_FindFieldByNumber(grpc_gcp_AltsContext_msg_init(), 7);
  _upb_Message_ClearNonExtensionField(msg, &field);
}
