...
extern const GRPCUPB upb_MiniTable* grpc_gcp_Endpoint_msg_init();
extern const GRPCUPB upb_MiniTable* grpc_gcp_Identity_msg_init();
extern const GRPCUPB upb_MiniTable* grpc_gcp_Identity_AttributesEntry_msg_init();
extern const GRPCUPB upb_MiniTable* grpc_gcp_StartClientHandshakeReq_msg_init();
extern const GRPCUPB upb_MiniTable* grpc_gcp_ServerHandshakeParameters_msg_init();
extern const GRPCUPB upb_MiniTable* grpc_gcp_StartServerHandshakeReq_msg_init();
extern const GRPCUPB upb_MiniTable* grpc_gcp_StartServerHandshakeReq_HandshakeParametersEntry_msg_init();
extern const GRPCUPB upb_MiniTable* grpc_gcp_NextHandshakeMessageReq_msg_init();
extern const GRPCUPB upb_MiniTable* grpc_gcp_HandshakerReq_msg_init();
extern const GRPCUPB upb_MiniTable* grpc_gcp_HandshakerResult_msg_init();
extern const GRPCUPB upb_MiniTable* grpc_gcp_HandshakerStatus_msg_init();
extern const GRPCUPB upb_MiniTable* grpc_gcp_HandshakerResp_msg_init();
extern const GRPCUPB upb_MiniTable* grpc_gcp_RpcProtocolVersions_msg_init();
extern const GRPCUPB upb_MiniTableEnum* grpc_gcp_HandshakeProtocol_enum_init();
extern const GRPCUPB upb_MiniTableEnum* grpc_gcp_NetworkProtocol_enum_init();
...
UPB_INLINE void grpc_gcp_Endpoint_clear_ip_address(grpc_gcp_Endpoint* msg) {
  const upb_MiniTableField field = *upb_MiniTable_FindFieldByNumber(grpc_gcp_Endpoint_msg_init(), 1);
...
UPB_INLINE void grpc_gcp_Endpoint_clear_port(grpc_gcp_Endpoint* msg) {
  const upb_MiniTableField field = *upb_MiniTable_FindFieldByNumber(grpc_gcp_Endpoint_msg_init(), 2);
  _upb_Message_ClearNonExtensionField(msg, &field);
}
...
UPB_INLINE void grpc_gcp_Endpoint_clear_protocol(grpc_gcp_Endpoint* msg) {
  const upb_MiniTableField field = *upb_MiniTable_FindFieldByNumber(grpc_gcp_Endpoint_msg_init(), 3);
  _upb_Message_ClearNonExtensionField(msg, &field);
}
...
UPB_INLINE grpc_gcp_Identity_identity_oneof_oneofcases grpc_gcp_Identity_identity_oneof_case(const grpc_gcp_Identity* msg) {
  const upb_MiniTableField field = *upb_MiniTable_FindFieldByNumber(grpc_gcp_Identity_msg_init(), 1);
...
UPB_INLINE void grpc_gcp_Identity_clear_hostname(grpc_gcp_Identity* msg) {
  const upb_MiniTableField field = *upb_MiniTable_FindFieldByNumber(grpc_gcp_Identity_msg_init(), 2);
  _upb_Message_ClearNonExtensionField(msg, &field);
}
...
UPB_INLINE void grpc_gcp_Identity_clear_attributes(grpc_gcp_Identity* msg) {
  const upb_MiniTableField field = *upb_MiniTable_FindFieldByNumber(grpc_gcp_Identity_msg_init(), 3);
  _upb_Message_ClearNonExtensionField(msg, &field);
}
...
UPB_INLINE void grpc_gcp_StartClientHandshakeReq_clear_handshake_security_protocol(grpc_gcp_StartClientHandshakeReq* msg) {
  const upb_MiniTableField field = *upb_MiniTable_FindFieldByNumber(grpc_gcp_StartClientHandshakeReq_msg_init(), 1);
  _upb_Message_ClearNonExtensionField(msg, &field);
}
...
UPB_INLINE void grpc_gcp_StartClientHandshakeReq_clear_application_protocols(grpc_gcp_StartClientHandshakeReq* msg) {
  const upb_MiniTableField field = *upb_MiniTable_FindFieldByNumber(grpc_gcp_StartClientHandshakeReq_msg_init(), 2);
  _upb_Message_ClearNonExtensionField(msg, &field);
}
...
UPB_INLINE void grpc_gcp_StartClientHandshakeReq_clear_record_protocols(grpc_gcp_StartClientHandshakeReq* msg) {
  const upb_MiniTableField field = *upb_MiniTable_FindFieldByNumber(grpc_gcp_StartClientHandshakeReq_msg_init(), 3);
  _upb_Message_ClearNonExtensionField(msg, &field);
}
...
UPB_INLINE void grpc_gcp_StartClientHandshakeReq_clear_target_identities(grpc_gcp_StartClientHandshakeReq* msg) {
  const upb_MiniTableField field = *upb_MiniTable_FindFieldByNumber(grpc_gcp_StartClientHandshakeReq_msg_init(), 4);
  _upb_Message_ClearNonExtensionField(msg, &field);
}
...
UPB_INLINE void grpc_gcp_StartClientHandshakeReq_clear_local_identity(grpc_gcp_StartClientHandshakeReq* msg) {
  const upb_MiniTableField field = *upb_MiniTable_FindFieldByNumber(grpc_gcp_StartClientHandshakeReq_msg_init(), 5);
  _upb_Message_ClearNonExtensionField(msg, &field);
}
...
UPB_INLINE void grpc_gcp_StartClientHandshakeReq_clear_local_endpoint(grpc_gcp_StartClientHandshakeReq* msg) {
  const upb_MiniTableField field = *upb_MiniTable_FindFieldByNumber(grpc_gcp_StartClientHandshakeReq_msg_init(), 6);
  _upb_Message_ClearNonExtensionField(msg, &field);
}
...
UPB_INLINE void grpc_gcp_StartClientHandshakeReq_clear_remote_endpoint(grpc_gcp_StartClientHandshakeReq* msg) {
  const upb_MiniTableField field = *upb_MiniTable_FindFieldByNumber(grpc_gcp_StartClientHandshakeReq_msg_init(), 7);
  _upb_Message_ClearNonExtensionField(msg, &field);
}
...
UPB_INLINE void grpc_gcp_StartClientHandshakeReq_clear_target_name(grpc_gcp_StartClientHandshakeReq* msg) {
  const upb_MiniTableField field = *upb_MiniTable_FindFieldByNumber(grpc_gcp_StartClientHandshakeReq_msg_init(), 8);
  _upb_Message_ClearNonExtensionField(msg, &field);
}
...
UPB_INLINE void grpc_gcp_StartClientHandshakeReq_clear_rpc_versions(grpc_gcp_StartClientHandshakeReq* msg) {
  const upb_MiniTableField field = *upb_MiniTable_FindFieldByNumber(grpc_gcp_StartClientHandshakeReq_msg_init(), 9);
  _upb_Message_ClearNonExtensionField(msg, &field);
}
...
UPB_INLINE void grpc_gcp_StartClientHandshakeReq_clear_max_frame_size(grpc_gcp_StartClientHandshakeReq* msg) {
  const upb_MiniTableField field = *upb_MiniTable_FindFieldByNumber(grpc_gcp_StartClientHandshakeReq_msg_init(), 10);
  _upb_Message_ClearNonExtensionField(msg, &field);
}
...
UPB_INLINE upb_StringView* grpc_gcp_StartClientHandshakeReq_mutable_application_protocols(grpc_gcp_StartClientHandshakeReq* msg, size_t* size) {
  upb_MiniTableField field = *upb_MiniTable_FindFieldByNumber(grpc_gcp_StartClientHandshakeReq_msg_init(), 2);
...
UPB_INLINE upb_StringView* grpc_gcp_StartClientHandshakeReq_mutable_record_protocols(grpc_gcp_StartClientHandshakeReq* msg, size_t* size) {
  upb_MiniTableField field = *upb_MiniTable_FindFieldByNumber(grpc_gcp_StartClientHandshakeReq_msg_init(), 3);
  upb_Array* arr = upb_Message_GetMutableArray(msg, &field);
  if (arr) {
    if (size) *size = arr->size;
    return (upb_StringView*)_upb_array_ptr(arr);
...
UPB_INLINE grpc_gcp_Identity** grpc_gcp_StartClientHandshakeReq_mutable_target_identities(grpc_gcp_StartClientHandshakeReq* msg, size_t* size) {
  upb_MiniTableField field = *upb_MiniTable_FindFieldByNumber(grpc_gcp_StartClientHandshakeReq_msg_init(), 4);
  upb_Array* arr = upb_Message_GetMutableArray(msg, &field);
  if (arr) {
    if (size) *size = arr->size;
...
UPB_INLINE void grpc_gcp_ServerHandshakeParameters_clear_record_protocols(grpc_gcp_ServerHandshakeParameters* msg) {
  const upb_MiniTableField field = *upb_MiniTable_FindFieldByNumber(grpc_gcp_ServerHandshakeParameters_msg_init(), 1);
  _upb_Message_ClearNonExtensionField(msg, &field);
}
...
UPB_INLINE void grpc_gcp_ServerHandshakeParameters_clear_local_identities(grpc_gcp_ServerHandshakeParameters* msg) {
  const upb_MiniTableField field = *upb_MiniTable_FindFieldByNumber(grpc_gcp_ServerHandshakeParameters_msg_init(), 2);
  _upb_Message_ClearNonExtensionField(msg, &field);
}
...
UPB_INLINE upb_StringView* grpc_gcp_ServerHandshakeParameters_mutable_record_protocols(grpc_gcp_ServerHandshakeParameters* msg, size_t* size) {
  upb_MiniTableField field = *upb_MiniTable_FindFieldByNumber(grpc_gcp_ServerHandshakeParameters_msg_init(), 1);
  upb_Array* arr = upb_Message_GetMutableArray(msg, &field);
  if (arr) {
    if (size) *size = arr->size;
    return (upb_StringView*)_upb_array_ptr(arr);
...
UPB_INLINE grpc_gcp_Identity** grpc_gcp_ServerHandshakeParameters_mutable_local_identities(grpc_gcp_ServerHandshakeParameters* msg, size_t* size) {
  upb_MiniTableField field = *upb_MiniTable_FindFieldByNumber(grpc_gcp_ServerHandshakeParameters_msg_init(), 2);
  upb_Array* arr = upb_Message_GetMutableArray(msg, &field);
  if (arr) {
    if (size) *size = arr->size;
    return (grpc_gcp_Identity**)_upb_array_ptr(arr);
...
UPB_INLINE void grpc_gcp_StartServerHandshakeReq_clear_application_protocols(grpc_gcp_StartServerHandshakeReq* msg) {
  const upb_MiniTableField field = *upb_MiniTable_FindFieldByNumber(grpc_gcp_StartServerHandshakeReq_msg_init(), 1);
  _upb_Message_ClearNonExtensionField(msg, &field);
}
...
UPB_INLINE void grpc_gcp_StartServerHandshakeReq_clear_handshake_parameters(grpc_gcp_StartServerHandshakeReq* msg) {
  const upb_MiniTableField field = *upb_MiniTable_FindFieldByNumber(grpc_gcp_StartServerHandshakeReq_msg_init(), 2);
  _upb_Message_ClearNonExtensionField(msg, &field);
}
...
UPB_INLINE void grpc_gcp_StartServerHandshakeReq_clear_in_bytes(grpc_gcp_StartServerHandshakeReq* msg) {
  const upb_MiniTableField field = *upb_MiniTable_FindFieldByNumber(grpc_gcp_StartServerHandshakeReq_msg_init(), 3);
  _upb_Message_ClearNonExtensionField(msg, &field);
}
...
UPB_INLINE void grpc_gcp_StartServerHandshakeReq_clear_local_endpoint(grpc_gcp_StartServerHandshakeReq* msg) {
  const upb_MiniTableField field = *upb_MiniTable_FindFieldByNumber(grpc_gcp_StartServerHandshakeReq_msg_init(), 4);
  _upb_Message_ClearNonExtensionField(msg, &field);
}
...
UPB_INLINE void grpc_gcp_StartServerHandshakeReq_clear_remote_endpoint(grpc_gcp_StartServerHandshakeReq* msg) {
  const upb_MiniTableField field = *upb_MiniTable_FindFieldByNumber(grpc_gcp_StartServerHandshakeReq_msg_init(), 5);
  _upb_Message_ClearNonExtensionField(msg, &field);
}
...
UPB_INLINE void grpc_gcp_StartServerHandshakeReq_clear_rpc_versions(grpc_gcp_StartServerHandshakeReq* msg) {
  const upb_MiniTableField field = *upb_MiniTable_FindFieldByNumber(grpc_gcp_StartServerHandshakeReq_msg_init(), 6);
  _upb_Message_ClearNonExtensionField(msg, &field);
}
...
UPB_INLINE void grpc_gcp_StartServerHandshakeReq_clear_max_frame_size(grpc_gcp_StartServerHandshakeReq* msg) {
  const upb_MiniTableField field = *upb_MiniTable_FindFieldByNumber(grpc_gcp_StartServerHandshakeReq_msg_init(), 7);
  _upb_Message_ClearNonExtensionField(msg, &field);
}
...
UPB_INLINE upb_StringView* grpc_gcp_StartServerHandshakeReq_mutable_application_protocols(grpc_gcp_StartServerHandshakeReq* msg, size_t* size) {
  upb_MiniTableField field = *upb_MiniTable_FindFieldByNumber(grpc_gcp_StartServerHandshakeReq_msg_init(), 1);
  upb_Array* arr = upb_Message_GetMutableArray(msg, &field);
  if (arr) {
    if (size) *size = arr->size;
    return (upb_StringView*)_upb_array_ptr(arr);
...
UPB_INLINE bool grpc_gcp_StartServerHandshakeReq_HandshakeParametersEntry_has_value(const grpc_gcp_StartServerHandshakeReq_HandshakeParametersEntry* msg) {
  const upb_MiniTableField field = *upb_MiniTable_FindFieldByNumber(grpc_gcp_StartServerHandshakeReq_HandshakeParametersEntry_msg_init(), 2);
  return _upb_Message_HasNonExtensionField(msg, &field);
}
...
UPB_INLINE void grpc_gcp_NextHandshakeMessageReq_clear_in_bytes(grpc_gcp_NextHandshakeMessageReq* msg) {
  const upb_MiniTableField field = *upb_MiniTable_FindFieldByNumber(grpc_gcp_NextHandshakeMessageReq_msg_init(), 1);
  _upb_Message_ClearNonExtensionField(msg, &field);
}
...
UPB_INLINE grpc_gcp_HandshakerReq_req_oneof_oneofcases grpc_gcp_HandshakerReq_req_oneof_case(const grpc_gcp_HandshakerReq* msg) {
  const upb_MiniTableField field = *upb_MiniTable_FindFieldByNumber(grpc_gcp_HandshakerReq_msg_init(), 1);
...
UPB_INLINE void grpc_gcp_HandshakerReq_clear_server_start(grpc_gcp_HandshakerReq* msg) {
  const upb_MiniTableField field = *upb_MiniTable_FindFieldByNumber(grpc_gcp_HandshakerReq_msg_init(), 2);
  _upb_Message_ClearNonExtensionField(msg, &field);
}
...
UPB_INLINE void grpc_gcp_HandshakerReq_clear_next(grpc_gcp_HandshakerReq* msg) {
  const upb_MiniTableField field = *upb_MiniTable_FindFieldByNumber(grpc_gcp_HandshakerReq_msg_init(), 3);
  _upb_Message_ClearNonExtensionField(msg, &field);
}
...
UPB_INLINE void grpc_gcp_HandshakerResult_clear_application_protocol(grpc_gcp_HandshakerResult* msg) {
  const upb_MiniTableField field = *upb_MiniTable_FindFieldByNumber(grpc_gcp_HandshakerResult_msg_init(), 1);
  _upb_Message_ClearNonExtensionField(msg, &field);
}
...
UPB_INLINE void grpc_gcp_HandshakerResult_clear_record_protocol(grpc_gcp_HandshakerResult* msg) {
  const upb_MiniTableField field = *upb_MiniTable_FindFieldByNumber(grpc_gcp_HandshakerResult_msg_init(), 2);
  _upb_Message_ClearNonExtensionField(msg, &field);
}
...
UPB_INLINE void grpc_gcp_HandshakerResult_clear_key_data(grpc_gcp_HandshakerResult* msg) {
  const upb_MiniTableField field = *upb_MiniTable_FindFieldByNumber(grpc_gcp_HandshakerResult_msg_init(), 3);
  _upb_Message_ClearNonExtensionField(msg, &field);
}
...
UPB_INLINE void grpc_gcp_HandshakerResult_clear_peer_identity(grpc_gcp_HandshakerResult* msg) {
  const upb_MiniTableField field = *upb_MiniTable_FindFieldByNumber(grpc_gcp_HandshakerResult_msg_init(), 4);
  _upb_Message_ClearNonExtensionField(msg, &field);
}
...
UPB_INLINE void grpc_gcp_HandshakerResult_clear_local_identity(grpc_gcp_HandshakerResult* msg) {
  const upb_MiniTableField field = *upb_MiniTable_FindFieldByNumber(grpc_gcp_HandshakerResult_msg_init(), 5);
  _upb_Message_ClearNonExtensionField(msg, &field);
}
...
UPB_INLINE void grpc_gcp_HandshakerResult_clear_keep_channel_open(grpc_gcp_HandshakerResult* msg) {
  const upb_MiniTableField field = *upb_MiniTable_FindFieldByNumber(grpc_gcp_HandshakerResult_msg_init(), 6);
  _upb_Message_ClearNonExtensionField(msg, &field);
}
...
UPB_INLINE void grpc_gcp_HandshakerResult_clear_peer_rpc_versions(grpc_gcp_HandshakerResult* msg) {
  const upb_MiniTableField field = *upb_MiniTable_FindFieldByNumber(grpc_gcp_HandshakerResult_msg_init(), 7);
  _upb_Message_ClearNonExtensionField(msg, &field);
}
...
UPB_INLINE void grpc_gcp_HandshakerResult_clear_max_frame_size(grpc_gcp_HandshakerResult* msg) {
  const upb_MiniTableField field = *upb_MiniTable_FindFieldByNumber(grpc_gcp_HandshakerResult_msg_init(), 8);
  _upb_Message_ClearNonExtensionField(msg, &field);
}
...
UPB_INLINE void grpc_gcp_HandshakerStatus_clear_code(grpc_gcp_HandshakerStatus* msg) {
  const upb_MiniTableField field = *upb_MiniTable_FindFieldByNumber(grpc_gcp_HandshakerStatus_msg_init(), 1);
  _upb_Message_ClearNonExtensionField(msg, &field);
}
...
UPB_INLINE void grpc_gcp_HandshakerStatus_clear_details(grpc_gcp_HandshakerStatus* msg) {
  const upb_MiniTableField field = *upb_MiniTable_FindFieldByNumber(grpc_gcp_HandshakerStatus_msg_init(), 2);
  _upb_Message_ClearNonExtensionField(msg, &field);
}
...
UPB_INLINE void grpc_gcp_HandshakerResp_clear_out_frames(grpc_gcp_HandshakerResp* msg) {
  const upb_MiniTableField field = *upb_MiniTable_FindFieldByNumber(grpc_gcp_HandshakerResp_msg_init(), 1);
  _upb_Message_ClearNonExtensionField(msg, &field);
}
...
UPB_INLINE void grpc_gcp_HandshakerResp_clear_bytes_consumed(grpc_gcp_HandshakerResp* msg) {
  const upb_MiniTableField field = *upb_MiniTable_FindFieldByNumber(grpc_gcp_HandshakerResp_msg_init(), 2);
  _upb_Message_ClearNonExtensionField(msg, &field);
}
...
UPB_INLINE void grpc_gcp_HandshakerResp_clear_result(grpc_gcp_HandshakerResp* msg) {
  const upb_MiniTableField field = *upb_MiniTable_FindFieldByNumber(grpc_gcp_HandshakerResp_msg_init(), 3);
  _upb_Message_ClearNonExtensionField(msg, &field);
}
...
UPB_INLINE void grpc_gcp_HandshakerResp_clear_status(grpc_gcp_HandshakerResp* msg) {
  const upb_MiniTableField field = *upb_MiniTable_FindFieldByNumber(grpc_gcp_HandshakerResp_msg_init(), 4);
  _upb_Message_ClearNonExtensionField(msg, &field);
}
