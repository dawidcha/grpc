...
typedef GRPC_DLL const char*(*grpc_version_string_type)(void);
...
typedef GRPC_DLL const grpc_auth_property*(*grpc_auth_property_iterator_next_type)(grpc_auth_property_iterator* it);
extern grpc_auth_property_iterator_next_type grpc_auth_property_iterator_next_import;
#define grpc_auth_property_iterator_next grpc_auth_property_iterator_next_import
typedef GRPC_DLL grpc_auth_property_iterator(*grpc_auth_context_property_iterator_type)(const grpc_auth_context* ctx);
...
typedef GRPC_DLL grpc_auth_property_iterator(*grpc_auth_context_peer_identity_type)(const grpc_auth_context* ctx);
...
typedef GRPC_DLL grpc_auth_property_iterator(*grpc_auth_context_find_properties_by_name_type)(const grpc_auth_context* ctx, const char* name);
...
typedef GRPC_DLL const char*(*grpc_auth_context_peer_identity_property_name_type)(const grpc_auth_context* ctx);
...
typedef GRPC_DLL int(*grpc_auth_context_peer_is_authenticated_type)(const grpc_auth_context* ctx);
...
typedef GRPC_DLL grpc_auth_context*(*grpc_call_auth_context_type)(grpc_call* call);
...
typedef GRPC_DLL void(*grpc_auth_context_release_type)(grpc_auth_context* context);
...
typedef GRPC_DLL void(*grpc_auth_context_add_property_type)(grpc_auth_context* ctx, const char* name, const char* value, size_t value_length);
...
typedef GRPC_DLL void(*grpc_auth_context_add_cstring_property_type)(grpc_auth_context* ctx, const char* name, const char* value);
...
typedef GRPC_DLL int(*grpc_auth_context_set_peer_identity_property_name_type)(grpc_auth_context* ctx, const char* name);
...
typedef GRPC_DLL grpc_ssl_session_cache*(*grpc_ssl_session_cache_create_lru_type)(size_t capacity);
...
typedef GRPC_DLL void(*grpc_ssl_session_cache_destroy_type)(grpc_ssl_session_cache* cache);
...
typedef GRPC_DLL grpc_arg(*grpc_ssl_session_cache_create_channel_arg_type)(grpc_ssl_session_cache* cache);
...
typedef GRPC_DLL void(*grpc_call_credentials_release_type)(grpc_call_credentials* creds);
...
typedef GRPC_DLL grpc_channel_credentials*(*grpc_google_default_credentials_create_type)(grpc_call_credentials* call_credentials);
extern grpc_google_default_credentials_create_type grpc_google_default_credentials_create_import;
#define grpc_google_default_credentials_create grpc_google_default_credentials_create_import
typedef GRPC_DLL void(*grpc_set_ssl_roots_override_callback_type)(grpc_ssl_roots_override_callback cb);
...
typedef GRPC_DLL grpc_channel_credentials*(*grpc_ssl_credentials_create_type)(const char* pem_root_certs, grpc_ssl_pem_key_cert_pair* pem_key_cert_pair, const verify_peer_options* verify_options, void* reserved);
...
typedef GRPC_DLL grpc_channel_credentials*(*grpc_ssl_credentials_create_ex_type)(const char* pem_root_certs, grpc_ssl_pem_key_cert_pair* pem_key_cert_pair, const grpc_ssl_verify_peer_options* verify_options, void* reserved);
...
typedef GRPC_DLL grpc_channel_credentials*(*grpc_composite_channel_credentials_create_type)(grpc_channel_credentials* channel_creds, grpc_call_credentials* call_creds, void* reserved);
...
typedef GRPC_DLL grpc_call_credentials*(*grpc_composite_call_credentials_create_type)(grpc_call_credentials* creds1, grpc_call_credentials* creds2, void* reserved);
...
typedef GRPC_DLL grpc_call_credentials*(*grpc_google_compute_engine_credentials_create_type)(void* reserved);
...
typedef GRPC_DLL gpr_timespec(*grpc_max_auth_token_lifetime_type)(void);
...
typedef GRPC_DLL grpc_call_credentials*(*grpc_service_account_jwt_access_credentials_create_type)(const char* json_key, gpr_timespec token_lifetime, void* reserved);
...
typedef GRPC_DLL grpc_call_credentials*(*grpc_external_account_credentials_create_type)(const char* json_string, const char* scopes_string);
...
typedef GRPC_DLL grpc_call_credentials*(*grpc_google_refresh_token_credentials_create_type)(const char* json_refresh_token, void* reserved);
...
typedef GRPC_DLL grpc_call_credentials*(*grpc_access_token_credentials_create_type)(const char* access_token, void* reserved);
...
typedef GRPC_DLL grpc_call_credentials*(*grpc_google_iam_credentials_create_type)(const char* authorization_token, const char* authority_selector, void* reserved);
...
typedef GRPC_DLL grpc_call_credentials*(*grpc_sts_credentials_create_type)(const grpc_sts_credentials_options* options, void* reserved);
...
typedef GRPC_DLL void(*grpc_auth_metadata_context_copy_type)(grpc_auth_metadata_context* from, grpc_auth_metadata_context* to);
...
typedef GRPC_DLL void(*grpc_auth_metadata_context_reset_type)(grpc_auth_metadata_context* context);
...
typedef GRPC_DLL grpc_call_credentials*(*grpc_metadata_credentials_create_from_plugin_type)(grpc_metadata_credentials_plugin plugin, grpc_security_level min_security_level, void* reserved);
...
typedef GRPC_DLL grpc_ssl_server_certificate_config*(*grpc_ssl_server_certificate_config_create_type)(const char* pem_root_certs, const grpc_ssl_pem_key_cert_pair* pem_key_cert_pairs, size_t num_key_cert_pairs);
...
typedef GRPC_DLL void(*grpc_ssl_server_certificate_config_destroy_type)(grpc_ssl_server_certificate_config* config);
...
typedef GRPC_DLL grpc_server_credentials*(*grpc_ssl_server_credentials_create_type)(const char* pem_root_certs, grpc_ssl_pem_key_cert_pair* pem_key_cert_pairs, size_t num_key_cert_pairs, int force_client_auth, void* reserved);
...
typedef GRPC_DLL grpc_server_credentials*(*grpc_ssl_server_credentials_create_ex_type)(const char* pem_root_certs, grpc_ssl_pem_key_cert_pair* pem_key_cert_pairs, size_t num_key_cert_pairs, grpc_ssl_client_certificate_request_type client_certificate_request, void* reserved);
...
typedef GRPC_DLL grpc_ssl_server_credentials_options*(*grpc_ssl_server_credentials_create_options_using_config_type)(grpc_ssl_client_certificate_request_type client_certificate_request, grpc_ssl_server_certificate_config* certificate_config);
...
typedef GRPC_DLL grpc_ssl_server_credentials_options*(*grpc_ssl_server_credentials_create_options_using_config_fetcher_type)(grpc_ssl_client_certificate_request_type client_certificate_request, grpc_ssl_server_certificate_config_callback cb, void* user_data);
...
typedef GRPC_DLL void(*grpc_ssl_server_credentials_options_destroy_type)(grpc_ssl_server_credentials_options* options);
...
typedef GRPC_DLL grpc_server_credentials*(*grpc_ssl_server_credentials_create_with_options_type)(grpc_ssl_server_credentials_options* options);
...
typedef GRPC_DLL grpc_call_error(*grpc_call_set_credentials_type)(grpc_call* call, grpc_call_credentials* creds);
...
typedef GRPC_DLL void(*grpc_server_credentials_set_auth_metadata_processor_type)(grpc_server_credentials* creds, grpc_auth_metadata_processor processor);
...
typedef GRPC_DLL grpc_alts_credentials_options*(*grpc_alts_credentials_client_options_create_type)(void);
...
typedef GRPC_DLL grpc_alts_credentials_options*(*grpc_alts_credentials_server_options_create_type)(void);
...
typedef GRPC_DLL void(*grpc_alts_credentials_client_options_add_target_service_account_type)(grpc_alts_credentials_options* options, const char* service_account);
...
typedef GRPC_DLL void(*grpc_alts_credentials_options_destroy_type)(grpc_alts_credentials_options* options);
...
typedef GRPC_DLL grpc_channel_credentials*(*grpc_alts_credentials_create_type)(const grpc_alts_credentials_options* options);
...
typedef GRPC_DLL grpc_server_credentials*(*grpc_alts_server_credentials_create_type)(const grpc_alts_credentials_options* options);
...
typedef GRPC_DLL grpc_channel_credentials*(*grpc_local_credentials_create_type)(grpc_local_connect_type type);
...
typedef GRPC_DLL grpc_server_credentials*(*grpc_local_server_credentials_create_type)(grpc_local_connect_type type);
...
typedef GRPC_DLL grpc_tls_identity_pairs*(*grpc_tls_identity_pairs_create_type)();
...
typedef GRPC_DLL void(*grpc_tls_identity_pairs_add_pair_type)(grpc_tls_identity_pairs* pairs, const char* private_key, const char* cert_chain);
...
typedef GRPC_DLL void(*grpc_tls_identity_pairs_destroy_type)(grpc_tls_identity_pairs* pairs);
...
typedef GRPC_DLL grpc_tls_certificate_provider*(*grpc_tls_certificate_provider_static_data_create_type)(const char* root_certificate, grpc_tls_identity_pairs* pem_key_cert_pairs);
...
typedef GRPC_DLL grpc_tls_certificate_provider*(*grpc_tls_certificate_provider_file_watcher_create_type)(const char* private_key_path, const char* identity_certificate_path, const char* root_cert_path, unsigned int refresh_interval_sec);
...
typedef GRPC_DLL void(*grpc_tls_certificate_provider_release_type)(grpc_tls_certificate_provider* provider);
...
typedef GRPC_DLL grpc_tls_credentials_options*(*grpc_tls_credentials_options_create_type)(void);
...
typedef GRPC_DLL void(*grpc_tls_credentials_options_set_certificate_provider_type)(grpc_tls_credentials_options* options, grpc_tls_certificate_provider* provider);
...
typedef GRPC_DLL void(*grpc_tls_credentials_options_watch_root_certs_type)(grpc_tls_credentials_options* options);
...
typedef GRPC_DLL void(*grpc_tls_credentials_options_set_root_cert_name_type)(grpc_tls_credentials_options* options, const char* root_cert_name);
...
typedef GRPC_DLL void(*grpc_tls_credentials_options_watch_identity_key_cert_pairs_type)(grpc_tls_credentials_options* options);
...
typedef GRPC_DLL void(*grpc_tls_credentials_options_set_identity_cert_name_type)(grpc_tls_credentials_options* options, const char* identity_cert_name);
...
typedef GRPC_DLL void(*grpc_tls_credentials_options_set_cert_request_type_type)(grpc_tls_credentials_options* options, grpc_ssl_client_certificate_request_type type);
...
typedef GRPC_DLL void(*grpc_tls_credentials_options_set_crl_directory_type)(grpc_tls_credentials_options* options, const char* crl_directory);
...
typedef GRPC_DLL void(*grpc_tls_credentials_options_set_verify_server_cert_type)(grpc_tls_credentials_options* options, int verify_server_cert);
...
typedef GRPC_DLL void(*grpc_tls_credentials_options_set_send_client_ca_list_type)(grpc_tls_credentials_options* options, bool send_client_ca_list);
...
typedef GRPC_DLL void(*grpc_tls_credentials_options_set_check_call_host_type)(grpc_tls_credentials_options* options, int check_call_host);
...
typedef GRPC_DLL grpc_channel_credentials*(*grpc_insecure_credentials_create_type)();
...
typedef GRPC_DLL grpc_server_credentials*(*grpc_insecure_server_credentials_create_type)();
...
typedef GRPC_DLL grpc_channel_credentials*(*grpc_xds_credentials_create_type)(grpc_channel_credentials* fallback_credentials);
...
typedef GRPC_DLL grpc_server_credentials*(*grpc_xds_server_credentials_create_type)(grpc_server_credentials* fallback_credentials);
...
typedef GRPC_DLL grpc_authorization_policy_provider*(*grpc_authorization_policy_provider_static_data_create_type)(const char* authz_policy, grpc_status_code* code, const char** error_details);
...
typedef GRPC_DLL grpc_authorization_policy_provider*(*grpc_authorization_policy_provider_file_watcher_create_type)(const char* authz_policy_path, unsigned int refresh_interval_sec, grpc_status_code* code, const char** error_details);
...
typedef GRPC_DLL void(*grpc_authorization_policy_provider_release_type)(grpc_authorization_policy_provider* provider);
...
typedef GRPC_DLL void(*grpc_tls_credentials_options_set_tls_session_key_log_file_path_type)(grpc_tls_credentials_options* options, const char* path);
